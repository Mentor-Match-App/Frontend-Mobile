...
MyClassMentorMondel myClassMentorMondelFromMap(String str) => MyClassMentorMondel.fromMap(json.decode(str));

String myClassMentorMondelToMap(MyClassMentorMondel data) => json.encode(data.toMap());
...
class MyClassMentorMondel {
    ...
    factory MyClassMentorMondel.fromMap(Map<String, dynamic> json) => MyClassMentorMondel(
        error: json["error"],
...
class User {
    ...
    factory User.fromMap(Map<String, dynamic> json) => User(
        ...
        userClass: json["class"] == null ? [] : List<Class>.from(json["class"]!.map((x) => Class.fromMap(x))),
        session: json["session"] == null ? [] : List<Session>.from(json["session"]!.map((x) => Session.fromMap(x))),
    ...
    Map<String, dynamic> toMap() => {
        ...
        "class": userClass == null ? [] : List<dynamic>.from(userClass!.map((x) => x.toMap())),
...
class Evaluation {
    ...
    factory Evaluation.fromMap(Map<String, dynamic> json) => Evaluation(
        ...
        topic: json["topic"],
        link: json["link"],
        feedbacks: json["feedbacks"] == null ? [] : List<Feedback>.from(json["feedbacks"]!.map((x) => Feedback.fromMap(x))),
    );
    ...
    Map<String, dynamic> toMap() => {
        ...
        "topic": topic,
        "link": link,
        "feedbacks": feedbacks == null ? [] : List<dynamic>.from(feedbacks!.map((x) => x.toMap())),
    };
}
