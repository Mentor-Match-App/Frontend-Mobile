...
import 'package:mentormatch_apps/screen/MyClass/review_mentor_screen.dart';
...
class DetailMyClassScreen extends StatefulWidget {
  DetailMyClassScreen({Key? key}) : super(key: key);

  @override
  State<DetailMyClassScreen> createState() => _DetailMyClassScreenState();
}

class _DetailMyClassScreenState extends State<DetailMyClassScreen> {
  @override
