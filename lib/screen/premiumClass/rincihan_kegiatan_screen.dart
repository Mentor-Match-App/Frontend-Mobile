...
class RincianKegiatanScreen extends StatefulWidget {
  RincianKegiatanScreen({Key? key}) : super(key: key);

  @override
  State<RincianKegiatanScreen> createState() => _RincianKegiatanScreenState();
}

class _RincianKegiatanScreenState extends State<RincianKegiatanScreen> {
  @override
