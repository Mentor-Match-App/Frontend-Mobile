...
class QualityAnsuranceSessionScreen extends StatefulWidget {
  QualityAnsuranceSessionScreen({Key? key}) : super(key: key);

  @override
  State<QualityAnsuranceSessionScreen> createState() => _QualityAnsuranceSessionScreenState();
}

class _QualityAnsuranceSessionScreenState extends State<QualityAnsuranceSessionScreen> {
    ...
    return FutureBuilder<Session>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          final mentorsWithQualityAnsuranceSession = snapshot.data!.mentors!
              .where((mentor) => mentor.session!.any(
                  (sessionElement) => sessionElement.category == "Quality Assurance"))
              .toList();
          ...
          return GridView.builder(
            ...
            itemCount: mentorsWithQualityAnsuranceSession.length,
            itemBuilder: (context, index) {
              final mentor = mentorsWithQualityAnsuranceSession[index];
