...
class QualityAnsuranceSessionScreen extends StatefulWidget {
  ...
  @override
  State<QualityAnsuranceSessionScreen> createState() =>
      _QualityAnsuranceSessionScreenState();
}

class _QualityAnsuranceSessionScreenState
    extends State<QualityAnsuranceSessionScreen> {
