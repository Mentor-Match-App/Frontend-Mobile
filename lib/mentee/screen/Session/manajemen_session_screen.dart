...
class ManajemenSessionScreen extends StatefulWidget {
  ManajemenSessionScreen({Key? key}) : super(key: key);

  @override
  State<ManajemenSessionScreen> createState() => _ManajemenSessionScreenState();
}

class _ManajemenSessionScreenState extends State<ManajemenSessionScreen> {
    ...
    return FutureBuilder<Session>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          final mentorsWithManajemenSession = snapshot.data!.mentors!
              .where((mentor) => mentor.session!.any(
                  (sessionElement) => sessionElement.category == "Manajemen"))
              .toList();
          ...
          return GridView.builder(
            ...
            itemCount: mentorsWithManajemenSession.length,
