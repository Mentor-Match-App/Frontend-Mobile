...
class FinanceSessionScreen extends StatefulWidget {
  FinanceSessionScreen({Key? key}) : super(key: key);

  @override
  State<FinanceSessionScreen> createState() => _FinanceSessionScreenState();
}

class _FinanceSessionScreenState extends State<FinanceSessionScreen> {
    ...
    return FutureBuilder<Session>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          final mentorsWithFinanceSession = snapshot.data!.mentors!
              .where((mentor) => mentor.session!.any(
                  (sessionElement) => sessionElement.category == "Finance"))
              .toList();
          ...
          return GridView.builder(
            ...
            itemCount: mentorsWithFinanceSession.length,
            itemBuilder: (context, index) {
              final mentor = mentorsWithFinanceSession[index];
