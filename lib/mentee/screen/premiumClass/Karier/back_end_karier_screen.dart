...
class BackEndKarierScreen extends StatefulWidget {
  BackEndKarierScreen({Key? key}) : super(key: key);

  @override
  State<BackEndKarierScreen> createState() => _BackEndKarierScreenState();
}
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          final mentorsWithLanguageCategory = snapshot.data!.mentors!
              .where((mentor) => mentor.mentorClass?.category == "Back End")
              .toList();
