...
class FinanceKarierScreen extends StatefulWidget {
  FinanceKarierScreen({Key? key}) : super(key: key);

  @override
  State<FinanceKarierScreen> createState() => _FinanceKarierScreenState();
}

class _FinanceKarierScreenState extends State<FinanceKarierScreen> {
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          final mentorsWithLanguageCategory = snapshot.data!.mentors!
              .where((mentor) => mentor.mentorClass?.category == "Finance")
              .toList();
