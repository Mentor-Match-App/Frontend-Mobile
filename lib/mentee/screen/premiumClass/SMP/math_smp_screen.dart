...
class MathSMPScreen extends StatefulWidget {
  MathSMPScreen({Key? key}) : super(key: key);

  @override
  State<MathSMPScreen> createState() => _MathSMPScreenState();
}

class _MathSMPScreenState extends State<MathSMPScreen> {
