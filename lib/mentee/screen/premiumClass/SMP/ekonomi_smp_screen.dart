...
class EkonomiSMPScreen extends StatefulWidget {
  EkonomiSMPScreen({Key? key}) : super(key: key);

  @override
  State<EkonomiSMPScreen> createState() => _EkonomiSMPScreenState();
}

class _EkonomiSMPScreenState extends State<EkonomiSMPScreen> {
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          final mentorsWithLanguageCategory = snapshot.data!.mentors!
              .where((mentor) => mentor.mentorClass?.category == "Ekonomi")
              .toList();
