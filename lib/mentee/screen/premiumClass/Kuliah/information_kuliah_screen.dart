...
class InformationKuliahScreen extends StatefulWidget {
  InformationKuliahScreen({Key? key}) : super(key: key);

  @override
  State<InformationKuliahScreen> createState() => _InformationKuliahScreenState();
}

class _InformationKuliahScreenState extends State<InformationKuliahScreen> {
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          final mentorsWithLanguageCategory = snapshot.data!.mentors!
              .where((mentor) => mentor.mentorClass?.category == "Teknik Informasi")
              .toList();
