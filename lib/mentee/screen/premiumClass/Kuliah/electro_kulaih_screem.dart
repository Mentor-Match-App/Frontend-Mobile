...
class ElectroKuliahScreen extends StatefulWidget {
  const ElectroKuliahScreen({Key? key}) : super(key: key);

  @override
  State<ElectroKuliahScreen> createState() => _ElectroKuliahScreenState();
}

class _ElectroKuliahScreenState extends State<ElectroKuliahScreen> {
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          final mentorsWithLanguageCategory = snapshot.data!.mentors!
              .where((mentor) => mentor.mentorClass?.category == "Teknik Elektro")
              .toList();
          ...
          return GridView.builder(
            ...
            shrinkWrap: true,
            physics:
                const ScrollPhysics(), // Mengizinkan scroll jika di dalam SingleChildScrollView
          );
        } else {
