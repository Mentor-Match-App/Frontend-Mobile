...
class DetailClassMentorKuliah extends StatefulWidget {
  ...
  @override
  State<DetailClassMentorKuliah> createState() =>
      _DetailClassMentorKuliahState();
}

class _DetailClassMentorKuliahState extends State<DetailClassMentorKuliah> {
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        "Lokasi : ${widget.addressMentoring.isEmpty ? "Meeting Zoom" : widget.addressMentoring}",
                        style: FontFamily().regularText,
                      )
                    ],
                  ),
