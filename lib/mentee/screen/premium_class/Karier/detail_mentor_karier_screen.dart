...
import 'package:mentormatch_apps/mentee/screen/premium_class/karier/detail_class_mentor_Karier_screen.dart';
...
class DetailMentorKarierScreen extends StatefulWidget {
  ...
  final List<ExperienceKarier> experiences;
  final List<TransactionKarier>? transaction;
  final String classid;
  // final int periode;
  final List<MentorRevieKarier>? reviews;
  // final int price;
  final List<ClassMentorKarier>? classes;
  final String about;
