...
class DetailClassMentorKarier extends StatefulWidget {
  final String locationMentoring;
  final String addressMentoring;
  final String mentorName;
  final List<TransactionKarier>? transaction;
  ...
  @override
  State<DetailClassMentorKarier> createState() =>
      _DetailClassMentorKarierState();
}

class _DetailClassMentorKarierState extends State<DetailClassMentorKarier> {
