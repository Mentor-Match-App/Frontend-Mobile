...
class TechSDScreen extends StatefulWidget {
  TechSDScreen({Key? key}) : super(key: key);

  @override
  State<TechSDScreen> createState() => _TechSDScreenState();
}

class _TechSDScreenState extends State<TechSDScreen> {
