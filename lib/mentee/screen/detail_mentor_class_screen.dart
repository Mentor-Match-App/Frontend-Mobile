...
import 'package:mentormatch_apps/mentee/screen/detail_class_mentor_screen.dart';
...
class DetailMentorClassAllScreen extends StatefulWidget {
  final List<ExperienceClassAll> experiences;
  final String classid;

  final List<MentorReviewClassAll>? reviews;
  final List<TransactionClassAll>? transaction;
  final List<ClassAll>? classes;
  final String about;
  ...
  @override
  State<DetailMentorClassAllScreen> createState() =>
      _DetailMentorClassAllScreenState();
}
...
class _DetailMentorClassAllScreenState
  ...
  Widget buildReviewWidgets() {
    print("Reviews: ${widget.reviews?.length ?? 'No reviews loaded.'}");
