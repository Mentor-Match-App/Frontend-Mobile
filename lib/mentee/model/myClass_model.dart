...
class UserMyClass {
    ...
    factory UserMyClass.fromMap(Map<String, dynamic> json) => UserMyClass(
        ...
        userClass: json["class"] == null ? [] : List<dynamic>.from(json["class"]!.map((x) => x)),
        session: json["session"] == null ? [] : List<dynamic>.from(json["session"]!.map((x) => x)),
        transactions: json["transactions"] == null ? [] : List<TransactionMyClass>.from(json["transactions"]!.map((x) => TransactionMyClass.fromMap(x))),
        participant: json["participant"] == null ? [] : List<ParticipantMyClass>.from(json["participant"]!.map((x) => ParticipantMyClass.fromMap(x))),
    ...
    Map<String, dynamic> toMap() => {
        ...
        "class": userClass == null ? [] : List<dynamic>.from(userClass!.map((x) => x)),
...
class ParticipantMyClass {
    ...
    factory ParticipantMyClass.fromMap(Map<String, dynamic> json) => ParticipantMyClass(
        sessionId: json["sessionId"],
        userId: json["userId"],
        session: json["session"] == null ? null : SessionMyClass.fromMap(json["session"]),
    );
...
class TransactionMyClass {
    ...
    factory TransactionMyClass.fromMap(Map<String, dynamic> json) => TransactionMyClass(
        id: json["id"],
        ...
        userId: json["userId"],
        transactionClass: json["class"] == null ? null : ClassMyClass.fromMap(json["class"]),
    );
...
class ClassMyClass {
    ...
    factory ClassMyClass.fromMap(Map<String, dynamic> json) => ClassMyClass(
        ...
        zoomLink: json["zoomLink"],
        mentor: json["mentor"] == null ? null : Mentor.fromMap(json["mentor"]),
        evaluations: json["evaluations"] == null ? [] : List<EvaluationMyClass>.from(json["evaluations"]!.map((x) => EvaluationMyClass.fromMap(x))),
        learningMaterial: json["learningMaterial"] == null ? [] : List<LearningMaterialMyClass>.from(json["learningMaterial"]!.map((x) => LearningMaterialMyClass.fromMap(x))),
    );
    ...
    Map<String, dynamic> toMap() => {
        ...
        "learningMaterial": learningMaterial == null ? [] : List<dynamic>.from(learningMaterial!.map((x) => x.toMap())),
    };
}
...
class EvaluationMyClass {
    ...
    factory EvaluationMyClass.fromMap(Map<String, dynamic> json) => EvaluationMyClass(
        id: json["id"],
        classId: json["classId"],
        createdAt: json["createdAt"],
        topic: json["topic"],
...
class LearningMaterialMyClass {
    ...
    factory LearningMaterialMyClass.fromMap(Map<String, dynamic> json) => LearningMaterialMyClass(
        id: json["id"],
        classId: json["classId"],
        title: json["title"],
        link: json["link"],
