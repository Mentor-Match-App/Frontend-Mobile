...
MenteeModel menteeModelFromMap(String str) => MenteeModel.fromMap(json.decode(str));
...
class MenteeModel {
    ...
    factory MenteeModel.fromMap(Map<String, dynamic> json) => MenteeModel(
        ...
        mentees: json["mentees"] == null ? [] : List<Mentee>.from(json["mentees"]!.map((x) => Mentee.fromMap(x))),
    );

    Map<String, dynamic> toMap() => {
        "error": error,
        "message": message,
        "mentees": mentees == null ? [] : List<dynamic>.from(mentees!.map((x) => x.toMap())),
    };
}
